...
tmpfile_sampled_reads = 'tmpfile_sampled_reads_1'
tmpfile_barcode_removed = 'tmpfile_barcode_removed_1'
tmpfile_decoded = 'tmpfile_decoded_1'
...
for i in [2,3,4]:
    ...
    while True:
        ...
        for t in range(num_trials):
            ...
            dna_storage.decode_data(tmpfile_barcode_removed,oligo_len,tmpfile_decoded,bin_index_len[i],BCH_bits[i],LDPC_alpha[i],LDPC_path_prefix+LDPC_code[i],file_size,eps=eps[i],sync=sync[i],sync_pos=sync_pos, attempt_indel_cor=False)
