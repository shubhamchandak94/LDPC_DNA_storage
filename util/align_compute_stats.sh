...
$MINIMAP2 -ax sr $DATA_PATH/oligo_files/oligos_1.fa $DATA_PATH/fastq/exp_1.fastq > $DATA_PATH/aligned/exp_1.sam
$MINIMAP2 -ax sr $DATA_PATH/oligo_files/oligos_2.fa $DATA_PATH/fastq/exp_2.fastq > $DATA_PATH/aligned/exp_2.sam
$MINIMAP2 -ax sr $DATA_PATH/oligo_files/merged_3-9.fa $DATA_PATH/fastq/exp_3-9.fastq > $DATA_PATH/aligned/exp_3-9.sam
...
for i in {3..9}; do
    $SAMTOOLS view -h -L $DATA_PATH/oligo_files/oligos_$i.bed $DATA_PATH/aligned/exp_3-9.sam > $DATA_PATH/aligned/exp_aligned_$i.sam
done
